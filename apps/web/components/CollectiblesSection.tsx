...
const COLLECTIBLE = {
  media: {
    type: "image" as const,
    src: "/colecionaveis/product-thumb.png",
        ...
        <div className={styles.header}>
          ...
          <div className={styles.subtitleRow}>
            <p className={styles.subtitle}>
              <span className={styles.subtitleAccent}>Expedição</span> Holiday
              in Camboja & Bangkok
            </p>
            <span className={`${styles.pillSlot} ${styles.pillSlotSm}`}>
              <Pill label="5/10 vagas" showIcon={false} size="sm" />
            </span>
            <span className={`${styles.pillSlot} ${styles.pillSlotMd}`}>
              <Pill label="5/10 vagas" showIcon={false} size="md" />
            </span>
          </div>
        </div>
